        ...
        NavigationStack(path: $viewModel.path) {
            VStack{
                ...
                HStack{
                    ...
                    // 아이디 찾기
                    Button {
                        viewModel.searchEmailButtonTapped = true
                    } label: {
                        Text("아이디 찾기")
                            .font(.subheadline)
                            .foregroundStyle(Color("LoginViewTextColor"))
                    }
                    .navigationDestination(isPresented: $viewModel.searchEmailButtonTapped) {
                        SearchEmailView()
                    }
                    ...
                    // 비밀번호 찾기
                    Button {
                        viewModel.searchPasswordButtonTapped = true
                    } label: {
                        Text("비밀번호 찾기")
                            .font(.subheadline)
                            .foregroundStyle(Color("LoginViewTextColor"))
                    }
                    .navigationDestination(isPresented: $viewModel.searchPasswordButtonTapped) {
                        SearchPasswordView()
                    }
                    ...
                    // 회원가입
                    Button {
                        viewModel.signUpButtonTapped = true
                    } label: {
                        Text("회원가입")
                            .font(.subheadline)
                            .foregroundStyle(Color("LoginViewTextColor"))
                    }
                    .navigationDestination(isPresented: $viewModel.signUpButtonTapped) {
                        EmailView()
                    }
